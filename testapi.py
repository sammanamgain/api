...
# data = pd.read_csv("C:\\Users\\amgai\\OneDrive\\Desktop\\development\\projects\\flutterwithflask\\API\\New_Data.csv")
# data = data["value"]
...
def forecast():
    ...
    # Convert the input data to a Pandas dataframe
                      ...
                      #input_df1 = pd.DataFrame(input_data, columns=['age'])
                      #print(input_df1)
                      age=input_df['age'][0]
                      print(age)
...
# apply differencing to make the data stationary if necessary
    ...
    # spilting the dataset
                     ...
                     #  X_train = pd.concat([X_train, input_df['value']], ignore_index=True)
                     #  print(X_train)
                     ...
                     #  prediction_dict = future_predictions.to_dict(orient='records')
